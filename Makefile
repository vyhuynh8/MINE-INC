...
SOURCES            = TITLE.c WIN.c LOST.c main.c myLib.c bg2.c bg1.c sprites.c game.c stateScreen.c pon.c hit.c back22.c bg11.c starting.c win3.c lost3.c pause3.c INSTR3.c LEVEL1.c LEVEL2.c LEVEL3.c INSTR2.c TRACK1.c TRACK2.c TRACK4.c TRACK3.c INSTR4.c INSTR1.c
DKPATH             = /Users/vy/Documents/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = wine /Users/vy/Desktop/vba.exe
FIND               = find
COPY               = cp -r
